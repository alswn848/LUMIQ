  ...
  "routine": [
    {
      "step": 1,
      "name": "클렌징",
      "product": "이 피부 타입에 맞는 클렌저 제형 타입 (예: 저자극 젤 클렌저, 밀크 클렌저)",
      "description": "클렌징 방법과 주의사항 — 세안 횟수, 물 온도, 마사지 강도 포함",
      "tip": "이 피부 타입 전용 실전 팁 — 흔한 실수와 대처법 포함"
    },
    {
      "step": 2,
      "name": "토너",
      "product": "추천 토너 제형과 질감 (예: 수분 토너, 진정 토너)",
      "description": "토너 선택 기준과 사용법 — 핵심 성분 기준 포함",
      "tip": "토너 레이어링 또는 코튼패드 vs 손으로 바르기 등 활용 팁"
    },
    {
      "step": 3,
      "name": "세럼/에센스",
      "product": "이 피부 문제에 집중하는 세럼 타입 (예: 보습 세럼, 진정 세럼, 피지 조절 세럼)",
      "description": "핵심 타겟 성분과 기대 효과 — 얼마나 쓸 것인지 양도 포함",
      "tip": "아침·저녁 사용 여부 및 다른 제품과 레이어링 순서 팁"
    },
    {
      "step": 4,
      "name": "수분크림",
      "product": "이 피부 타입에 맞는 크림 질감 (예: 라이트 젤 크림, 리치 크림, 배리어 크림)",
      "description": "보습 방법과 흡수시키는 법 — 적정 사용량 포함",
      "tip": "T존과 U존 구분 사용 등 부위별 활용 팁"
    },
    {
      "step": 5,
      "name": "선크림",
